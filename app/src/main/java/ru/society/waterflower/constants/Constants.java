package ru.society.waterflower.constants;
...
public interface Constants {
    ...
    public static final String WEB_SITE = "https://vipsoch.com/";  //web site url address
    ...
    public static final String API_DOMAIN = "https://vipsoch.com/";  // url address to which the application sends requests
